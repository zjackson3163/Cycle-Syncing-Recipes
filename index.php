...
<?php include 'view/navbar.php'; ?>
    <body class = "inside">
        ...
        <div class="container">
            ...
            <section id="phase_pic_container">
                <a class = "phase_links" href="recipe_list.php?phase_id=1">
                    <img class = "phase_pics" src="images/Winter.png" alt="winter branches">
                </a>
                ...
                <a class = "phase_links" href="recipe_list.php?phase_id=4">
                    <img class = "phase_pics" src="images/Fall.png" alt="fall branches">
                </a>
            </section>
